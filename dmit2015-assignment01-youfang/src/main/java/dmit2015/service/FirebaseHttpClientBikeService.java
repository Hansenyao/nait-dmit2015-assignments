...
/**
 * This class implements the BikeService using the HttpClient library to send Http Request to the Firebase Realtime Database REST API.
 */

@Named("firebaseHttpClientBikeService")
@ApplicationScoped
public class FirebaseHttpClientBikeService implements BikeService {
    /**
    ...
    public Bike createBike(Bike bike) {
        ...
        jsonAllDataPath = String.format("%s/%s.json", firebaseRtdbBaseUrl, Bike.class.getSimpleName());
    ...
    public Optional<Bike> getBikeById(String id) {
        ...
        String jsonSingleDataPath = String.format("%s/%s/%s.json",
                firebaseRtdbBaseUrl, Bike.class.getSimpleName(), id);
        try {
    ...
    public Bike updateBike(Bike bike) {
        // Build the url path to object to update
        String jsonSingleDataPath = String.format("%s/%s/%s.json",
                firebaseRtdbBaseUrl, Bike.class.getSimpleName(), bike.getId());
